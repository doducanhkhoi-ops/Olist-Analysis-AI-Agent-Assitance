...
proj_name = "Fulfillment_Handover_Diagnostic"
...
annotation PBI_QueryOrder = ["fact_fulfillment_quadrants","fact_regional_logistics_friction","fact_category_seller_overdue","fact_fulfillment_kpi_summary"]

annotation PBI_ProTooling = ["DevMode"]

ref table fact_fulfillment_quadrants
ref table fact_regional_logistics_friction
ref table fact_category_seller_overdue
ref table fact_fulfillment_kpi_summary
...
# 1. fact_fulfillment_quadrants
create_table_tmdl("fact_fulfillment_quadrants", [
...
], "fact_fulfillment_quadrants.csv")

# 2. fact_regional_logistics_friction
create_table_tmdl("fact_regional_logistics_friction", [
    ...
    ("avg_review_score", "double", None, "type number")
], "fact_regional_logistics_friction.csv")

# 3. fact_category_seller_overdue
create_table_tmdl("fact_category_seller_overdue", [
    ("category_name", "string", None, "type text"),
    ("total_orders", "int64", "#,##0", "Int64.Type"),
    ("seller_overdue_pct", "double", None, "type number"),
    ("avg_seller_handling_days", "double", None, "type number"),
    ("avg_review_score", "double", None, "type number")
], "fact_category_seller_overdue.csv")

# 4. fact_fulfillment_kpi_summary
create_table_tmdl("fact_fulfillment_kpi_summary", [
...
], "fact_fulfillment_kpi_summary.csv")
...
visual_configs = [
    ...
    ("a1000000000000000003", "a1000000000000000003", {
        "entity": "fact_fulfillment_quadrants",
        "property": "delivery_quadrant",
        "queryRef": "fact_fulfillment_quadrants.delivery_quadrant",
    ...
    ("a1000000000000000005", "a1000000000000000005", {
        "cat_entity": "fact_fulfillment_quadrants",
        "cat_prop": "delivery_quadrant_id",
        "val_entity": "fact_fulfillment_quadrants",
    ...
    ("a1000000000000000006", "a1000000000000000006", {
        "cat_entity": "fact_fulfillment_quadrants",
        "cat_prop": "delivery_quadrant_id",
        "y_entity": "fact_fulfillment_quadrants",
        "y_prop": "total_orders",
        "y2_entity": "fact_fulfillment_quadrants",
    ...
    ("a1000000000000000007", "a1000000000000000007", {
        "cat_entity": "fact_regional_logistics_friction",
        "cat_prop": "state",
        "val_entity": "fact_regional_logistics_friction",
